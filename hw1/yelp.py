...
def main ():
  ...
  print "time, lambda, RMS Train, RMS Validate, nonzeros"
  while l > 1:
    ...
    if cnt > 0:
      ...
      print stop - start, "," ,l ,"," , RMS(uvDataTrain,w,w0,uvLblTrain), "," , RMS(uvDataValidate,w,w0,uvLblValidate), ",", countNonZeros(w)
      sys.stdout.flush()
    else:
